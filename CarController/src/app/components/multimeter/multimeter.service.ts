...
export class MultimeterService {
    ...
    Mdata = {
        ...
        multimeterres() {
            ...
            this.Mint.In1NER_Multi_mirAmp_x_x = "0";
            // $('.opacitybox').hide();
            // this.arrowAnimate1(false);
            console.log(this.dropsuccessNum)
            if (this.dropsuccessNum && this.dropsuccessNum != 0 &&　!this.multimeterinsulated) {
        ...
        multimeterCircle() {
            ...
            if (this.multimeterinsulated) {
                if (this.dropsuccessNum === '1') {
                    ...
                    this.multimeterScreenNum = "550";
                    this.multimetershowDateUnit = 'MΩ';
                } else if (this.dropsuccessNum === '2') {
                    this.multimeterScreenUnit = "527v";
                    this.multimeterScreenNum = "0.00";
                    this.multimetershowDateUnit = '';
                } else {
        ...
        freshHontspot() {
            ...
            $("body").find('a').droppable({
                ...
                out: function (event, ui) {
                    ...
                    if ((_this.redposition === '1' && _this.blackposition === '2') || (_this.redposition === '1' && _this.blackposition === '3') ||
                        (_this.redposition === '2' && _this.blackposition === '1') || (_this.redposition === '3' && _this.blackposition === '1')) {
                        _this.dropsuccessNum = '1';
                    } else if ((_this.redposition === '2' && _this.blackposition === '3') || (_this.redposition === '3' && _this.blackposition === '2')) {
