...
export class DashboardComponent {
    ...
    constructor(public obdscanService: ObdscanService, public dashboardService: DashboardService, public gearPanelService: GearPanelService,public communicationService: CommunicationService, ) {
