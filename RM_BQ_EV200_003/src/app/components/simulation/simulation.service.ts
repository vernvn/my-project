...
export class SimulationService {
    ...
    sbtInt = {
        ...
        allsensor: {
            In1NER_PowBat_BalStart_x_x: this.balanceService.Mdata.Mint.In1NER_PowBat_BalStart_x_x,
            In1NER_PowBat_Charge_x_x : this.gearPanelService.Mint.In1NER_PowBat_Charge_x_x
        },
    };
    sbtobject = {};
    isTrue = true;
    ...
    getResources(resourcesUrl, paramObj, options) {
    ...
    exitSimulation(): void {
        this.getResources(this.resourcesUrl, this.timestamp, this.options)
    }
    outParam(): void {
         this.sbtInt.allsensor.In1NER_PowBat_BalStart_x_x=this.balanceService.Mdata.Mint.In1NER_PowBat_BalStart_x_x,
          this.sbtInt.allsensor.In1NER_PowBat_Charge_x_x=this.gearPanelService.Mint.In1NER_PowBat_Charge_x_x
        
        this.paramObj = JSON.stringify(this.sbtInt);
        this.getResources(this.resourcesUrl, this.paramObj, this.options)
            .then(data => {
                if (data == "error") {
            ...
            }).catch(error => this.handleErrorService.handleError(0))
    ...
    init(): void {
        ...
        this.getResources(this.resourcesUrl, q, this.options)
            .then(data => {
                if (this.isFlag) {
                    this.sh = setInterval(() => {
                        this.outParam();
    ...
    pluginValid(): void {
        //万用表输出=========================================================
        this.multimeterService.Mout.Out1NER_Multi_ToScreen_x_x = this.formatFloatTwo(this.sbtOut.Out1NER_Multi_ToScreen_x_x);
        //均衡仪表输出
        this.balanceService.Mout.Out1PowBat_111112_EPO = this.formatFloatTwo(this.sbtOut.Out1PowBat_111112_EPO);
        this.balanceService.Mout.Out1PowBat_112113_EPO = this.formatFloatTwo(this.sbtOut.Out1PowBat_112113_EPO);
        this.balanceService.Mout.Out1PowBat_113114_EPO = this.formatFloatTwo(this.sbtOut.Out1PowBat_113114_EPO);
        this.balanceService.Mout.Out1PowBat_114115_EPO = this.formatFloatTwo(this.sbtOut.Out1PowBat_114115_EPO);
        this.balanceService.Mout.Out1PowBat_115116_EPO = this.formatFloatTwo(this.sbtOut.Out1PowBat_115116_EPO);
        //仪表输出=========================================================
        ...
        this.dashboardService.Mout.Out1Mot_x_Power_x_x = this.sbtOut.Out1Mot_x_Power_x_x;    //功率表指针参数
        this.dashboardService.Mout.Out1Mot_x_VehSpeed_x_x = this.formatInt(this.sbtOut.Out1Mot_x_VehSpeed_x_x);    //车速
        this.dashboardService.checkSpeed(this.dashboardService.Mout.Out1Mot_x_VehSpeed_x_x);//检查车速
    ...
    formatFloat(src) {
        //     //加上特殊热区点
        if ((this.multimeterService.Mdata.Mint.In1MultiLogic_x_Pass2Ohm_x_x == "1") && (this.multimeterService.Mdata.Mint.In1MultiLogic_x_Black_x_x == '4123') && (this.multimeterService.Mdata.Mint.In1MultiLogic_x_Red_x_x == '4124')) {
            this.multimeterService.Mdata.multimeterScreenUnit = "MΩ";
            return "1.000";
        }
        if (this.multimeterService.Mdata.Mint.In1MultiLogic_x_Pass2Ohm_x_x == "1" && this.sbtOut.Out1MultiLogic_x_ToScreen_x_x == "1") {
            ...
            if (this.multimeterService.Mdata.Mint.In1MultiLogic_x_DCmVlt_x_x == "1") {
                ...
                if (this.multimeterService.Mdata.Mint.In1MultiLogic_x_Pass2Ohm_x_x == "1" && this.multimeterService.Mout.Out1MultiLogic_x_ToScreen_x_x != "1.") {
                ...
                if (src >= 0) {
                    ...
                    if (reg.test(src)) {
                        if (src.toString().split(".")[0].length >= 5) {
                            let num = src / 1000;
                            if (this.multimeterService.Mdata.Mint.In1MultiLogic_x_Pass2Ohm_x_x == "1") {
